...
public class ProductVariant: INode, IHasMetafields
{
    ...
    {
        Barcode = String.Empty, CompareAtPriceV2 = MoneyV2.Default, Id = String.Empty, Image = Image.Default,
        PriceV2 = MoneyV2.Default, QuantityAvailable = default, SelectedOptions = Array.Empty<SelectedOption>(),
        Sku = String.Empty
    };
}
